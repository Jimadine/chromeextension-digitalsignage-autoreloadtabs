...
chrome.alarms.onAlarm.addListener(function (alarm) {
  chrome.storage.local.get(['reload_interval', 'notification_period'], function (r) {
    if (alarm.name == alarmName) {
      ...
      notificationSeconds = r.notification_period !== undefined ? parseInt(r.notification_period) : 5;
      ...
      if (notificationSeconds === 0) {
        ...
        self.registration.showNotification(title, options)
          .then(() => new Promise(resolve => setTimeout(resolve, notificationSeconds * 1000)))
